...
Old Dataset – generated by ChatGPT was too deterministic causing a 1.00 recall, indicating the model lacked learning.
New Dataset – Old Dataset was refined, normalized and a CTGAN was used generate a synthetic data that is more diverse than the earlier version, recall dropped but the learning curve improved.
